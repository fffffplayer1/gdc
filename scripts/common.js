...
<a href="http://talmidstories.wikia.com/wiki/Captain%27s_Blog,_Stardate_Whatever_Wiki">Fleet Captain\' Blog, Stardate Whatever</a> </div>  \
</div>\
<div class="dropdown">  <button class="dropbtn" onclick="visitLink2()" onmouseover="navbarLink(this)" onmouseout="navbarLinkOut(this)">LMB Topics</button>      \
<div class="dropdown-content">    \
...
function visitLink2(){
	window.location.href = dots+'lmbtopics.html';
}
